...
class sContact extends Sites{
    ...
    public function setPicContact($fileName, $eventId){
        ...
        $req = mysqli_query($this->mysqli, $sql) or die('Erreur 500-I1, Merci de contacter l\'administrateur.');
    ...
    public function addContact ($txtContactSt, $mailContact, $idEvent){
        ...
        $req = mysqli_query($this->mysqli, $sql) or die('Erreur 500-I2, Merci de contacter l\'administrateur.');
