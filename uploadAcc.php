...
$nomDestination = strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-acc." . $extensionFichier);
...
if (in_array($extensionFichier, $extensionsAutorisees)) {
	...
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-acc.jpg"));
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-acc.png"));
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-acc.pdf"));
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-acc.JPEG"));
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-acc.JPG"));
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-acc.PNG"));
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-acc.PDF"));
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-acc.jpeg"));
	...
	if (0 < $_FILES['file']['error']) {
		...
		if (move_uploaded_file($_FILES["file"]["tmp_name"], $repertoireDestination . $nomDestination)) {
			$usr->updateIdentiteAcc($id, $nomDestination);
				$reponse = "ok";
		}
	}
}else {
