...
$nomDestination = strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-trombinoscope." . $extensionFichier);
...
if (in_array($extensionFichier, $extensionsAutorisees)) {
	...
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-trombinoscope.jpeg"));
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-trombinoscope.jpg"));
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-trombinoscope.png"));
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-trombinoscope.pdf"));
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-trombinoscope.JPEG"));
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-trombinoscope.JPG"));
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-trombinoscope.PNG"));
	unlink(dirname(__FILE__) . "/" . $dossierimage . "/" . strtolower($id . "-" . $data['NOM'] .  "-" . $data['PRENOM']  . "-trombinoscope.PDF"));
	...
	if (0 < $_FILES['file']['error']) {
		...
		if (move_uploaded_file($_FILES["file"]["tmp_name"], $repertoireDestination . $nomDestination)) {
			$usr->updateTrombi($id, $nomDestination);
				$reponse = "ok";
		}
	}
}else {
